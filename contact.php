...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Ilkal Granite: Contact</title>
		...
		<main class="main">
			<div class="background-block background-block--contact">
				<section class="container-mid">
					<div class="background-block-content address-block">
						...
						<p><span class="icon-location_on icon-left"></span>Address: Hanamsagar Road, Ilkal, Karnataka 587125</p>				
